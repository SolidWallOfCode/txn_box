...
project = u'Transaction Box Plugin'
copyright = u'2019, amc@apache.org'
...
#html_title = None
html_title = "Transaction Box"

# A shorter title for the navigation bar.  Default is the same as html_title.
#html_short_title = None
html_short_title = "txn_box"
...
# pixels large.
#html_favicon = 'images/ngeo-icon.ico'
...
latex_documents = [
  ('index', 'TxnBox.tex', u'Apache Traffic Server Documentation',
...
texinfo_documents = [
  ('index', 'TransactoinBox', u'Transaction Box Documentation',
   u'amc@apache.og', 'TransactionBox', 'Transaction manipulation plugin for Apache Traffic Server.',
   'Miscellaneous'),
]
